...
public void loadNhanVien(NHANVIEN nvDM){
    ...
    private void initComponents() {
        ...
        Nhaptb.setModel(new javax.swing.table.DefaultTableModel(
        	    ...
        	    new String [] {
        	        "Mã Sách", "Tên Sách", "Số Lượng Còn Lại", "Đơn giá", "Nhà Xuất Bản", "Số lần tái bản"
        	    }
        	) {
        	    Class[] types = new Class [] {
        	        java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Long.class, java.lang.String.class, java.lang.Integer.class
        	    };
        	    boolean[] canEdit = new boolean [] {
        ...
        NCC = new JComboBox<>();
        NCC.setEditable(false); // Không cho phép chỉnh sửa trực tiếp
        NCC.setBackground(new java.awt.Color(204, 255, 204));
        NCC.setFont(new java.awt.Font("Segoe UI", 1, 12)); // Sử dụng font giống NV
        NCC.setForeground(new java.awt.Color(0, 51, 51));
        NCC.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nhà Cung Cấp", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 12), new java.awt.Color(0, 51, 51)));
        ThongTinNhapHangPanel.add(NCC);
        ...
        ThongTinNhapHangPanelLayout.setHorizontalGroup(
            ...
            .addGroup(ThongTinNhapHangPanelLayout.createSequentialGroup()
                ...
                .addGroup(ThongTinNhapHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(ThongTinNhapHangPanelLayout.createSequentialGroup()
                        .addGroup(ThongTinNhapHangPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(NCC, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loadNhaCungCap() {
        try {
            NhaXuatBanlmpl nxb = new NhaXuatBanlmpl(); // Thay bằng class quản lý nhà cung cấp của bạn
            DefaultComboBoxModel<String> model = new DefaultComboBoxModel<>();

            nxb.danhSachNhaCungCap(model);
